...
void HttpRequest::detHeader(const std::string &key) { m_headers.erase(key); }
void HttpRequest::detParam(const std::string &key) { m_params.erase(key); }
void HttpRequest::detCookie(const std::string &key) { m_cookies.erase(key); }
...
std::ostream &HttpResponse::dump(std::ostream &os) const {
  ...
  os << "connection: " << (m_close ? "close" : "keep-live") << "\r\n";
